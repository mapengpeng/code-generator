...
<head>
    ...
    <link rel="stylesheet" href="${request.contextPath}/css/layuimini.css?v=2.0.4.2" media="all">
...
<script src="${request.contextPath}/js/lay-config.js?v=2.0.0" charset="utf-8"></script>
<script>
